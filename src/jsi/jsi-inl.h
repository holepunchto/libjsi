...
template <typename T>
inline T
Runtime::make(Runtime::PointerValue *pv) {
  return T(pv);
}

inline Runtime::PointerValue *
Runtime::getPointerValue(jsi::Pointer &pointer) {
  return pointer.ptr_;
}

inline const Runtime::PointerValue *
Runtime::getPointerValue(
...
inline Value
Object::getProperty(Runtime &runtime, const char *name) const {
  return getProperty(runtime, String::createFromAscii(runtime, name));
}

inline Value
Object::getProperty(Runtime &runtime, const String &name) const {
  return runtime.getProperty(*this, name);
}

inline Value
Object::getProperty(Runtime &runtime, const PropNameID &name)
  const {
  return runtime.getProperty(*this, name);
}

inline bool
Object::hasProperty(Runtime &runtime, const char *name) const {
  return hasProperty(runtime, String::createFromAscii(runtime, name));
}

inline bool
Object::hasProperty(Runtime &runtime, const String &name) const {
  return runtime.hasProperty(*this, name);
}

inline bool
Object::hasProperty(Runtime &runtime, const PropNameID &name)
  const {
  return runtime.hasProperty(*this, name);
}
...
template <typename T>
void
Object::setProperty(Runtime &runtime, const char *name, T &&value) const {
  setProperty(
...
template <typename T>
void
Object::setProperty(Runtime &runtime, const String &name, T &&value)
  const {
  setPropertyValue(
...
template <typename T>
void
Object::setProperty(Runtime &runtime, const PropNameID &name, T &&value)
  const {
  setPropertyValue(
    runtime, name, detail::toValue(runtime, std::forward<T>(value))
  );
...
inline Array
Object::getArray(Runtime &runtime) const & {
...
inline Array
Object::getArray(Runtime &runtime) && {
  assert(runtime.isArray(*this));
  (void) runtime; // when assert is disabled we need to mark this as used
...
inline ArrayBuffer
Object::getArrayBuffer(Runtime &runtime) const & {
...
inline ArrayBuffer
Object::getArrayBuffer(Runtime &runtime) && {
  assert(runtime.isArrayBuffer(*this));
  (void) runtime; // when assert is disabled we need to mark this as used
  Runtime::PointerValue *value = ptr_;
  ptr_ = nullptr;
...
inline Function
Object::getFunction(Runtime &runtime) const & {
  assert(runtime.isFunction(*this));
  return Function(runtime.cloneObject(ptr_));
}

inline Function
Object::getFunction(Runtime &runtime) && {
  assert(runtime.isFunction(*this));
  (void) runtime; // when assert is disabled we need to mark this as used
  Runtime::PointerValue *value = ptr_;
  ptr_ = nullptr;
...
template <typename T>
inline bool
Object::isHostObject(Runtime &runtime) const {
...
template <>
inline bool
Object::isHostObject<HostObject>(Runtime &runtime) const {
  return runtime.isHostObject(*this);
}

template <typename T>
inline std::shared_ptr<T>
Object::getHostObject(Runtime &runtime) const {
...
template <typename T>
inline std::shared_ptr<T>
Object::asHostObject(Runtime &runtime) const {
...
Object::getHostObject<HostObject>(
  Runtime &runtime
) const {
...
template <typename T>
inline bool
Object::hasNativeState(Runtime &runtime) const {
...
template <>
inline bool
Object::hasNativeState<NativeState>(Runtime &runtime) const {
  return runtime.hasNativeState(*this);
}

template <typename T>
inline std::shared_ptr<T>
Object::getNativeState(Runtime &runtime) const {
...
inline void
Object::setExternalMemoryPressure(Runtime &runtime, size_t amt)
  const {
  runtime.setExternalMemoryPressure(*this, amt);
}

inline Array
Object::getPropertyNames(Runtime &runtime) const {
  return runtime.getPropertyNames(*this);
}

inline Value
WeakObject::lock(Runtime &runtime) const {
  return runtime.lockWeakObject(*this);
}

template <typename T>
void
Array::setValueAtIndex(Runtime &runtime, size_t i, T &&value) const {
  setValueAtIndexImpl(
...
inline Value
Array::getValueAtIndex(Runtime &runtime, size_t i) const {
...
inline Value
Function::call(Runtime &runtime, const Value *args, size_t count)
  const {
  return runtime.call(*this, Value::undefined(), args, count);
}

inline Value
Function::call(Runtime &runtime, std::initializer_list<Value> args)
  const {
...
inline Value
Function::call(Runtime &runtime, Args &&...args) const {
...
template <typename... Args>
inline Array
Array::createWithElements(Runtime &runtime, Args &&...args) {
...
template <typename... Args>
inline Value
Function::callAsConstructor(Runtime &runtime, Args &&...args)
  const {
...
String
BigInt::toString(Runtime &runtime, int radix) const {
